...
ALTER TABLE prescriptions ADD credit_card INT DEFAULT NULL, ADD auto_refill TINYINT(1) DEFAULT '0' NOT NULL, CHANGE line_item line_item INT DEFAULT NULL, CHANGE consultation consultation INT DEFAULT NULL, CHANGE date_modified date_modified DATETIME DEFAULT NULL;
ALTER TABLE prescriptions ADD CONSTRAINT FK_E41E1AC311D627EE FOREIGN KEY (credit_card) REFERENCES credit_cards (id) ON DELETE SET NULL;
CREATE INDEX IDX_E41E1AC311D627EE ON prescriptions (credit_card);
...
ALTER TABLE photos DROP FOREIGN KEY FK_876E0D98CDE5729;
...
ALTER TABLE photos ADD CONSTRAINT FK_876E0D98CDE5729 FOREIGN KEY (type) REFERENCES photo_types (id);
